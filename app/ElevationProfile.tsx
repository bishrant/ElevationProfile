...
class ElevationProfile extends declared(Widget) {
  ...
  private send(feat: any) {
    ...
    //format
    let format = {"fields":[{"name":"OID","type":"esriFieldTypeObjectID","alias":"OID"}],
  ...
  private displayLineChart(graphic: Graphic) {
    ...
    this.send(g);
    return;
    require(['https://cdn.plot.ly/plotly-latest.min.js'], function(Plotly: any) {
      const url = 'https://elevation.arcgis.com/arcgis/rest/services/Tools/ElevationSync/GPServer/Profile/execute';
      fetch(url, {
        method: 'POST',
        headers: {
